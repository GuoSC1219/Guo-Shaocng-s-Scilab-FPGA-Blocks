...
class seu_dpd_opfb_4_3_32ch(DSPBlock):
    def initialize(self):
        self.add_source('seu_dpd_opfb_4_3_32ch/*')
    ...
    def gen_tcl_cmds(self):
        ...
        file_path = '%s/scilab_library/hdl_sources/seu_dpd_opfb_4_3_32ch/fir_block.tcl' % env_var  
        new_first_line = '  set fircoe_source %s/scilab_library/hdl_sources/seu_dpd_opfb_4_3_32ch/FIRS\n' % env_var  
        with open(file_path, "r", encoding="utf-8") as f:
            lines = f.readlines()  
        lines[5490] = new_first_line  
        with open(file_path, "w", encoding="utf-8") as f:
            f.writelines(lines)
        tcl_cmds['pre_synth'] = ['source %s/scilab_library/hdl_sources/seu_dpd_opfb_4_3_32ch/fir_block.tcl' % env_var]
        return tcl_cmds
